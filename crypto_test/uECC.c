...
#define Curve_P_3 {0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0001, 0x0000, 0xFFFF, 0xFFFF}
#define Curve_P_4 {0xFC2F, 0xFFFF, 0xFFFE, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF}

#define Curve_B_1 {0xFA45, 0xC565, 0xD4AD, 0x81D4, 0xF89F, 0x65AC, 0x7A8B, 0x54BD, 0xBEFC, 0x1C97}
#define Curve_B_2 {0xB9B1, 0xC146, 0xDEEC, 0xFEB8, 0x3049, 0x7224, 0xE9AB, 0x0FA7, 0x80E7, 0xE59C, 0x0519, 0x6421}
#define Curve_B_3 {0x604B, 0x27D2, 0x3C3E, 0x3BCE, 0xB0F6, 0xCC53, 0x06B0, 0x651D, 0x86BC, 0x7698, 0xBD55, 0xB3EB, 0x93E7, 0xAA3A, 0x35D8, 0x5AC6}
#define Curve_B_4 {0x0007, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000}

#define Curve_G_1 { \
    {0xFC82, 0x13CB, 0x8BB9, 0x68C3, 0x6989, 0x4664, 0x7328, 0x8EF5, 0xB568, 0x4A96}, \
    {0xFB32, 0x7AC5, 0x5137, 0x0423, 0xC912, 0x59DC, 0x947D, 0x3168, 0x2855, 0x23A6}}

#define Curve_G_2 { \
    {0x1012, 0x82FF, 0x0AFD, 0xF4FF, 0x8800, 0x43A1, 0x20EB, 0x7CBF, 0x90F6, 0xB030, 0xA80E, 0x188D}, \
    {0x4811, 0x1E79, 0x77A1, 0x73F9, 0xCDD5, 0x6B24, 0x11ED, 0x6310, 0xDA78, 0xFFC8, 0x2B95, 0x0719}}
    
#define Curve_G_3 { \
    {0xC296, 0xD898, 0x3945, 0xF4A1, 0x33A0, 0x2DEB, 0x7D81, 0x7703, 0x40F2, 0x63A4, 0xE6E5, 0xF8BC, 0x4247, 0xE12C, 0xD1F2, 0x6B17}, \
    {0x51F5, 0x37BF, 0x4068, 0xCBB6, 0x5ECE, 0x6B31, 0x3357, 0x2BCE, 0x9E16, 0x7C0F, 0xEB4A, 0x8EE7, 0x7F9B, 0xFE1A, 0x42E2, 0x4FE3}}

#define Curve_G_4 { \
    {0x1798, 0x16F8, 0x815B, 0x59F2, 0x28D9, 0x2DCE, 0xFCDB, 0x029B, 0x0B07, 0xCE87, 0x6295, 0x55A0, 0xBBAC, 0xF9DC, 0x667E, 0x79BE}, \
    {0xD4B8, 0xFB10, 0xD08F, 0x9C47, 0x5419, 0xA685, 0xB448, 0xFD17, 0x08A8, 0x0E11, 0xFBFC, 0x5DA4, 0xC465, 0x26A3, 0xDA77, 0x483A}}

#define Curve_N_1 {0x2257, 0xCA75, 0xAED3, 0xF927, 0xF4C8, 0x0001, 0x0000, 0x0000, 0x0000, 0x0000, 0x0001}
#define Curve_N_2 {0x2831, 0xB4D2, 0xC9B1, 0x146B, 0xF836, 0x99DE, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF}
#define Curve_N_3 {0x2551, 0xFC63, 0xCAC2, 0xF3B9, 0x9E84, 0xA717, 0xFAAD, 0xBCE6, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x0000, 0x0000, 0xFFFF, 0xFFFF}
#define Curve_N_4 {0x4141, 0xD036, 0x5E8C, 0xBFD2, 0xA03B, 0xAF48, 0xDCE6, 0xBAAE, 0xFFFE, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF}
...
static void omega_mult(uint16_t * RESTRICT p_result, uint16_t * RESTRICT p_right)
{
	...
	/* Multiply by (2^31 + 1). */
	//TODO: Check
	vli_set(p_result + 2, p_right); /* 2^32 */
	vli_rshift1(p_result + 2); /* 2^31 */
	p_result[0] = p_right[0] << 15;
...
static void vli_bytesToNative(uint16_t *p_native, const uint8_t *p_bytes)
{
    unsigned i;
    for(i=0; i<uECC_WORDS; ++i)
    {
